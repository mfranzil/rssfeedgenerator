...
LOCAL_PORT = int(os.getenv("LOCAL_PORT", 35573))
REFRESH_TIME = int(os.getenv("REFRESH_TIME", 60 * 60 * 2))
...
DEFAULT_TIMEOUT_CONNECTION = int(os.getenv("DEFAULT_TIMEOUT_CONNECTION", 10))
MAX_DOWNLOAD_RETRIES = int(os.getenv("MAX_DOWNLOAD_RETRIES", 4))
